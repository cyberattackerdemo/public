...
echo "$(date '+%Y-%m-%d %H:%M:%S') | Capturing DNS traffic with tcpdump for 10 sec..." | tee -a $LOG_FILE
timeout 300 tcpdump -i any port 53 -w /home/troubleshoot/step1_tcpdump_dns.pcap
